...
export default function PlannerContainer() {
    ...
    <div>
      ...
      {!selectedLine && <div>
        <ComboboxLines placeholder="Search line..." lines={lines} setSelectedLine={setSelectedLine} />
      </div>}
      {/* Display the other part of the planner */}
      {selectedLine && <SelectStop selectedLine={selectedLine} setSelectedLine={setSelectedLine} />}
    </div>
  )
}